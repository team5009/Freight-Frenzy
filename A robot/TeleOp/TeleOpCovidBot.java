...
@TeleOp(name="TeleOpCovidBot", group="")
public class TeleOpCovidBot extends LinearOpMode {
  ...
  // initialization
     ...
     if (opModeIsActive()) {
      ...
      // tank drive equation
       ...
       L = Math.sqrt(gamepad1.left_stick_x * gamepad1.left_stick_x + gamepad1.left_stick_y * gamepad1.left_stick_y)*0.9;
       R = Math.sqrt(gamepad1.right_stick_x * gamepad1.right_stick_x + gamepad1.right_stick_y * gamepad1.right_stick_y)*0.9;
       driveSlowly();
          ...
          arm_pickup();
          small_arm();
          telemetry.addData("small Pos: ", "%f", Small.getPosition());
          big_arm();
          telemetry.addData("big Pos: ", "%f", Big.getPosition());
          telemetry.update();
          }
       }
      }
